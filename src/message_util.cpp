...
void message::init_options_description(po::options_description &desc)
{
    desc.add_options()
        ...
        ("require-existing,E", po::bool_switch(), "require all JIRA issue keys to represent existing JIRA issues (and get issue from server to do so)")
        ("require-unresolved,U", po::bool_switch(), "require all JIRA issues to be unresolved (and get issue from server to do so)")
        ("show-issue-summary,S", po::bool_switch(), "show issue summary (and get issue from server to do so)")
